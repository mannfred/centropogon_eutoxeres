...
ConsensusSequence(
  e2, 
  threshold = 0.15, #less than 15% of the sequences will not be represented #97% of seqs contain the information in the consensus
  ignoreNonBases = TRUE, 
...
# AAAAAAAAAAAAAAAAAAAAAAA 23 (t=0.05, mininfo = 1-t)
# BBBB 4
# CCCCCCCCCCCCCC 14
# DDDDD 5
# EEEEEEEEE 9
...
# AAAAAAAAAAAAAAAAAAAAAAABBBBBBBBBBBBBBBBBCCCCCCDDDDDDDDD #57 days
# AAAAAAAAAAAAAAAAAAAAA = 23
# BBBBBBBBBBBBBBBBBBBBB = 19
# CCCCCC = 6
# DDDDDDDDD = 9
