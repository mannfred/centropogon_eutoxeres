...
2_development_plotting.R
	This script takes the outputs (median stage durations) of the previous scripts and plots them for visualization purposes (used as Figure 4 in the manuscript). To plot, the file "2_ggplot_theme.R" needs to be run. 
